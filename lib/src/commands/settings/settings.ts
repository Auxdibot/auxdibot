import { Channel, ChannelType, Role, SlashCommandBuilder } from 'discord.js';
   ...
   subcommands: [
      ...
      },
      {
         ...
         async execute(interaction: AuxdibotCommandInteraction<GuildAuxdibotCommandData>) {
            ...
            if (
               (channel && channel.id == settings.join_leave_channel) ||
               (!channel && channel == settings.join_leave_channel)
            ) {
